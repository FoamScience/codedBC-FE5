...
#include "mixedCodedBCTemplate.H"
...
defineTypeNameAndDebug(${typeName}MixedValueFvPatch${FieldType}, 0);
addToRunTimeSelectionTable(fvPatch${FieldType}, ${typeName}MixedValueFvPatch${FieldType}, patch);
